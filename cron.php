...
$query = mysqli_query($link, "SELECT * FROM users WHERE vista='1' AND vista_email='1'");
...
if (mysqli_num_rows($query) > 0) {
	...
	while($info = mysqli_fetch_array($query)) {
		...
		$email = $info['email'];
		//PHPMAILER
		$mail->Subject = 'I9 - Tem mensagens pendentes';
...
<div style='line-height:25px;font-size:1px'>&#160;</div><!--[if mso]></td></tr></table><![endif]-->
	...
	<div style='color:#132F40;font-family:'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:120%; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;'>	
		<div style='font-size:12px;line-height:14px;color:#132F40;font-family:'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;'><p style='margin: 0;font-size: 14px;line-height: 17px'><span style='font-size: 22px; line-height: 26px;'>Olá&#160;<strong>". $nome." ".$apelido."</strong>, tem mensagens pendentes!</span></p></div>	
	</div>
	...
	<div style='color:#555555;font-family:'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:150%; padding-right: 10px; padding-left: 10px; padding-top: 5px; padding-bottom: 30px;'>	
		<div style='font-size:12px;line-height:18px;color:#555555;font-family:'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;'><p style='margin: 0;font-size: 14px;line-height: 21px'>Você tem mensagens pendentes.</p></div>	
	</div>
	<!--[if mso]></td></tr></table><![endif]-->
</div>
...
<table border='0' cellpadding='0' cellspacing='0' width='100%' class='divider ' style='border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 100%;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%'>
  ...
  <!--[if (mso)|(IE)]></div><![endif]-->
		...
		mysqli_query($link, "UPDATE users SET vista_email='0' WHERE id='$id_user'");
	}

}

$query_anos = mysqli_query($link, "SELECT * FROM users WHERE vista_anos='0'");
while ($info_anos = mysqli_fetch_array($query_anos)) {
	$data_nascimento = $info_anos['data_nascimento'];
	if (date("m-d") == substr($data_nascimento,5,5)) {
		$id_user = $info_anos['id'];
		$email = $info_anos['email'];
		$nome = $info_anos['nome'];
		$apelido = $info_anos['apelido'];
...
<div style='line-height:25px;font-size:1px'>&#160;</div><!--[if mso]></td></tr></table><![endif]-->
	...
	<!--[if mso]><table width='100%' cellpadding='0' cellspacing='0' border='0'><tr><td style='padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;'><![endif]-->
	<div style='color:#132F40;font-family:'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:120%; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;'>	
		<div style='font-size:12px;line-height:14px;color:#132F40;font-family:'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;'><p style='margin: 0;font-size: 14px;line-height: 17px'><span style='font-size: 22px; line-height: 26px;'>Parabéns&#160;<strong>". $nome." ".$apelido."</strong>!</span></p></div>	
	</div>
	<!--[if mso]></td></tr></table><![endif]-->
</div>
	...
	<!--[if mso]><table width='100%' cellpadding='0' cellspacing='0' border='0'><tr><td style='padding-right: 10px; padding-left: 10px; padding-top: 5px; padding-bottom: 30px;'><![endif]-->
	<div style='color:#555555;font-family:'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:150%; padding-right: 10px; padding-left: 10px; padding-top: 5px; padding-bottom: 30px;'>	
		<div style='font-size:12px;line-height:18px;color:#555555;font-family:'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;'><p style='margin: 0;font-size: 14px;line-height: 21px'>P A R A B E N S</p></div>	
	</div>
	<!--[if mso]></td></tr></table><![endif]-->
</div>
...
<!--[if mso]></td></tr></table><![endif]-->
	...
	<!--[if mso]><table width='100%' cellpadding='0' cellspacing='0' border='0'><tr><td style='padding-right: 10px; padding-left: 10px; padding-top: 20px; padding-bottom: 10px;'><![endif]-->
	<div style='color:#555555;font-family:'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:120%; padding-right: 10px; padding-left: 10px; padding-top: 20px; padding-bottom: 10px;'>	
		<div style='line-height:14px;font-size:12px;color:#555555;font-family:'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;'><p style='margin: 0;line-height: 14px;font-size: 12px'><span style='font-size: 16px; line-height: 19px;'>Parabéns, festeje o seu aniversário com <a href='http://www.inoverso.com/'>i9</a></span></p></div>	
	</div>
	<!--[if mso]></td></tr></table><![endif]-->
</div>
...
<table border='0' cellpadding='0' cellspacing='0' width='100%' class='divider ' style='border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 100%;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%'>
  ...
  <!--[if (mso)|(IE)]></div><![endif]-->
		...
		mysqli_query($link, "UPDATE users SET vista_anos='1' WHERE id='$id_user'");
	}
}
?>